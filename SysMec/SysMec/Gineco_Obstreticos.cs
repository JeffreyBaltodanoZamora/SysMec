...
namespace SysMec
{
    ...
    public partial class Gineco_Obstreticos
    {
        ...
        public Nullable<bool> vc_relaciones_sexuales { get; set; }
        public Nullable<bool> vc_planificar { get; set; }
        public Nullable<bool> vc_ritmo { get; set; }
        public string vc_metodo { get; set; }
        public string vc_duracion { get; set; }
        public Nullable<bool> vc_partos_eutocicos { get; set; }
        public Nullable<bool> vc_forceps { get; set; }
        public Nullable<bool> vc_cesareas { get; set; }
        public Nullable<bool> vc_flujos { get; set; }
        public string vc_sangrados_anormales { get; set; }
        public Nullable<bool> vc_pap { get; set; }
